...
int main(int argc, char *argv[]) {
    ...
    xquotes_json_storage::JsonStorage iStorage("test2.dat");
    json j1;
    j1["test"] = 1;
    j1["str"] = "Hello!";
    ...
    iStorage.write_json(j3, xtime::get_timestamp(3,1,2018));
    ...
    std::cout << "get_day_data " << iStorage.get_json(xtime::get_timestamp(3,1,2018)) << std::endl;
    system("pause");
    return 0;
}
